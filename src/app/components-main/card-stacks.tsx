      ...
      <div className="relative isolate overflow-hidden bg-gray-950 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
        ...
        <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
          <h2 className="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">
            Transforme sua ideia em um produto funcional.
          </h2>
          <p className="mt-6 text-lg/8 text-pretty text-gray-300">
            Desenvolvimento moderno, do front-end ao back-end, com foco em
            performance, escalabilidade e uma ótima experiência para o usuário.
        ...
        <div className="relative mt-16 h-80 lg:mt-8">
          <Image
            alt="App screenshot"
            src={`${process.env.NEXT_PUBLIC_BASE_PATH || ""}/stacks_1.png`}
            width={1824}
            height={1080}
