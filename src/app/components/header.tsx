...
export default function Header() {
  return (
    ...
    <Disclosure
      as="nav"
      className="sticky top-0 z-50 w-full bg-[rgba(0,4,12,0.7)] backdrop-blur-md shadow-md"
    >
      {/* Mobile menu button*/}
      ...
      <div className="container mx-auto flex h-16 items-center justify-between">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center space-x-2">
            <span className="text-xl font-bold text-gray-300 px-4">
              Andressa Cristiny
            </span>
          </Link>
        </div>
            ...
            {navigation.map((item) => (
              <Link
                ...
                className={classNames(
                  "text-base font-medium transition-colors hover:text-zinc-50 px-4"
                )}
              >
                {item.name}
              </Link>
...
//     <Disclosure
//       as="nav"
//       className="bg-[rgba(0,4,12,0.7)] backdrop-blur-md shadow-md"
//     >
...
//           {/* Navegação - Centralizados */}
//           <div className="hidden sm:flex sm:ml-6 sm:block">
...
//           {/* Contato (Botão "Entre em Contato") */}
